<template>
  <div class="hydration flex flex-col gap-6 items-start">
    ...
    <ul>
      ...
      <li>
        The client side js downloads and parses is where Vue gets initialized
      </li>
      <li>Vue makes a virtual dom</li>
      <li>
        Diffs that with the static markup, to add event listeners <<--even if
        there are none
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>Messages only on dev, better hydration messages</li>
      <li>Most the time its invalid markup</li>
    </ul>
    <h2>Time to interactivity</h2>
    <ul>
      <li>
        This page has alot of dom nodes, can't press the button right away
      </li>
    </ul>
    <h2>Server components</h2>
    <ul>
      <li>Skip hydration</li>
      <li>Can contain sensitive data like env keys</li>
